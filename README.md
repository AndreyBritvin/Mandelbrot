...
Для измерения производительности использовался расчётный режим работы и функция `rdtscp`, берущая количество тактов. Расчётный размер окна был `800*600` пикселей. Для каждого процессора и режима работы значения полученные от счётчика сведены в таблицу. К сожалению, в настоящий момент не удалось реализовать avx команды на процессоре i5 12600K
