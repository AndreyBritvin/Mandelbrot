...
err_code_t fill_pixels_SIMD_multithread (int* pixels, double x_center, double y_center, double scale);
err_code_t fill_pixels_SIMT       (int* pixels, double x_center, double y_center, double scale);
